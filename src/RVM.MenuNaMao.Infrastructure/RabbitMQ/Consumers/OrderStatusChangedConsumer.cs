...
public sealed class OrderStatusChangedConsumer(IOptions<RabbitMqSettings> settings, ILogger<OrderStatusChangedConsumer> logger)
    : BackgroundService
{
    private const string QueueName = "orders.status-changed";
